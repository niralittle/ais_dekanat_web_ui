...
<head>
  ...
  <title><spring:message code="cathedra.title" /></title>
...
<div id="wrap">
  ...
  <div class="col-md-offset-7 top-block">
    <form id="add-order-form" class="form-horizontal" method="get" action="/createCathedra">
      <div class="col-md-offset-7 col-md-4">
        <button id="Adm_Button" type="submit" class="btn btn-primary btn-block"><spring:message code="cathedra.create" /></button>
      </div>
    </form>
  </div>
  <div class="table-align bottom-block">
    <table id="records_table" class="tbl table table-striped user-table order-table">
      <thead>
      <tr>
        <th class="title-col"><spring:message code="cathedra.name" /><img class="icon-sort"
                                                                            src="../../../resources/img/sort15.png"
                                                                            width="8px" height="14px">
        </th>
        <th class="title-col"><spring:message code="cathedra.department" /><img class="icon-sort"
                                                                                   src="../../../resources/img/sort15.png"
                                                                                   width="8px"
                                                                                   height="14px">
        </th>
        <th class="title-col"><spring:message code="cathedra.professors" /><img class="icon-sort"
                                                                                src="../../../resources/img/sort15.png"
                                                                                width="8px"
                                                                                height="14px">
        </th>
      ...
      <c:forEach items="${cathedras}" var="cathedra">
        <tr>
          <td> ${cathedra.name}</td>
          <td> ${cathedra.department.name}</td>
          <td>
            <c:forEach items="${cathedra.professors}" var="professor">
